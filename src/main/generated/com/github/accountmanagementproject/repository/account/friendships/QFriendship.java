...
public class QFriendship extends EntityPathBase<Friendship> {
    ...
    private static final long serialVersionUID = -1311398355L;
    ...
    public final com.github.accountmanagementproject.repository.account.users.QMyUser myUser1;

    public final com.github.accountmanagementproject.repository.account.users.QMyUser myUser2;
    ...
    public QFriendship(Class<? extends Friendship> type, PathMetadata metadata, PathInits inits) {
        ...
        this.myUser1 = inits.isInitialized("myUser1") ? new com.github.accountmanagementproject.repository.account.users.QMyUser(forProperty("myUser1")) : null;
        this.myUser2 = inits.isInitialized("myUser2") ? new com.github.accountmanagementproject.repository.account.users.QMyUser(forProperty("myUser2")) : null;
    }
