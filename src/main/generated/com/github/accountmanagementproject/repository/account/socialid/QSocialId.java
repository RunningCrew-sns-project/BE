...
public class QSocialId extends EntityPathBase<SocialId> {
    ...
    private static final long serialVersionUID = 827494320L;
    ...
    public final com.github.accountmanagementproject.repository.account.user.QMyUser myUser;
    ...
    public QSocialId(Class<? extends SocialId> type, PathMetadata metadata, PathInits inits) {
        ...
        this.myUser = inits.isInitialized("myUser") ? new com.github.accountmanagementproject.repository.account.user.QMyUser(forProperty("myUser")) : null;
