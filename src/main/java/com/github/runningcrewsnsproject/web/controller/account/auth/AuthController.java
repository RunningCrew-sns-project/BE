package com.github.runningcrewsnsproject.web.controller.account.auth;


import com.github.runningcrewsnsproject.service.account.auth.SignUpLoginService;
import com.github.runningcrewsnsproject.service.account.auth.oauth.OAuthLoginService;
import com.github.runningcrewsnsproject.web.dto.account.auth.LoginRequest;
import com.github.runningcrewsnsproject.web.dto.account.auth.SignUpRequest;
import com.github.runningcrewsnsproject.web.dto.account.auth.TokenDto;
import com.github.runningcrewsnsproject.web.dto.account.auth.oauth.request.KakaoLoginParams;
import com.github.runningcrewsnsproject.web.dto.account.auth.oauth.request.NaverLoginParams;
import com.github.runningcrewsnsproject.web.dto.account.auth.oauth.request.OAuthLoginParams;
import com.github.runningcrewsnsproject.web.dto.account.auth.oauth.request.OAuthSignUpRequest;
import com.github.runningcrewsnsproject.web.dto.account.auth.oauth.response.AuthResult;
